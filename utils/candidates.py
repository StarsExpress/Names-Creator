...
def select_character(probs_array, top_k_elements=None):  # Given probability array, select by top-k method.
...
def select_surnames(size):  # Randomly select surnames with uniform probability.
